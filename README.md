...
- Local verification completed 80/80 workload runs with zero duplicate submissions or downloads; CI repeats the ten-run benchmark on Ubuntu headless Chromium and uploads the JSON report.
