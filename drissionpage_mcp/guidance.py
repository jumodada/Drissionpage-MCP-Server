...
VISION_DECISION_RULES: tuple[str, ...] = (
    ...
    "Use page_pointer_drag only for a visually identified coordinate drag; optional waypoints describe a bounded multi-segment path while press/move/release stay in one failure-safe call.",
