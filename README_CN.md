...
MCP 核心提供原子浏览器操作，Skills 在服务之外提供可审阅、可复用的流程：
...
- [x] 跨源 iframe、授权 Turnstile fixture、有界小红书类研究三个仓库示例 Skill 通过静态 catalog 发现，且不进入 wheel/sdist
